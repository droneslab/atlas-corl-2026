...
I’ve handed off a template-fidelity pass. Once it returns, I’ll either apply the minimal alignment edits or stop if the only remaining issue is visual preference.
