...
- The homepage contains:
  ...
  - workshop subtitle inside the hero banner: Active Sensing and Learning for Robot Perception
  - an Overview section framing ATLAS around active image formation, multimodal sensing control, sensing formation beyond cameras, and learning-based perception for embodied systems
  ...
  - a Program section with a planned half-day schedule covering welcome remarks, four invited talks, a poster session, lightning talks, challenge awards, and closing remarks
  - an Active Illumination Challenge section describing the fixed-trajectory simulation benchmark, participant control of robot-mounted illumination, and SLAM-based organizer evaluation
...
- Navigation is in-page anchor navigation with links for `Overview`, `Scope`, `Program`, `Challenge`, `Speakers`, `Call for Papers`, `Organizers`, and `Contact`.
...
- It is acceptable to publish a concise public-facing challenge summary, but do not add proposal-only resource, room, leaderboard, or evaluation logistics unless they are confirmed for public release.
